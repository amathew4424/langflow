...
The span.trace_id foreign key was missing ondelete="CASCADE", which caused
ForeignKeyViolation errors when deleting flows that had associated traces
and spans. This migration recreates the constraint with CASCADE.
"""
