...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Agentic Workflow documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Agentic Workflow: Create, Chain, Communicate.",
  ...
  "Design Dialogues with Agentic Workflow.",
...
export const LANGFLOW_CHAT_TITLE = "Agentic Workflow Chat";
...
export const STORE_TITLE = "Agentic Workflow Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Agentic Workflow API key.";
